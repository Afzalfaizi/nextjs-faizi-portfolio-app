      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <Link
            ...
            >
              <button className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-yellow-400 to-yellow-200 text-white">
              <span className="block bg-[#121212] hover: rounded-full px-5 py-2">
                Hire Me
              </span>
              </button>
            </Link>
